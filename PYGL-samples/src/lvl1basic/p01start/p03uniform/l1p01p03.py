...
class Main:
    ...
    def bind_buffers(self):
        ...
        loc_color = glGetAttribLocation(self.shader_program, "inColor")
        glBindBuffer(GL_ARRAY_BUFFER, self.vertex_buffer)
        glEnableVertexAttribArray(loc_position)
        glVertexAttribPointer(
                loc_position, # shader variable ID
        ...
        glVertexAttribPointer(loc_color, 3, GL_FLOAT, False, 20, ctypes.c_void_p(8))
