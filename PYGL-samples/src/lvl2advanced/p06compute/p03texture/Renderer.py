...
class Renderer(Abstract_renderer):
    ...
    def init(self):
        ...
        self.shader_program = ShaderUtils.load_program_directory(PATH+"shaders/lvl2advanced/p06compute/p03texture/drawImage")
        self.compute_shader_program = ShaderUtils.load_program_specific(None, None, None, None, None, 
                PATH+"shaders/lvl2advanced/p06compute/p03texture/computeTexture") 
        ...
        try:
            self.texture1 = OGLTexture2D().from_file(PATH+"res/textures/bricks.jpg")
            self.texture2 = OGLTexture2D().from_file(PATH+"res/textures/bricksn.png")
    ...
    def display(self):
        ...
        self.texture1.bind_slot(self.compute_shader_program, "texture1", 0)
        self.texture2.bind_slot(self.compute_shader_program, "texture2", 1)
        
        glUniform1i(self.loc_mode, self.mode%3) 
        
        glDispatchCompute(int(256/32), int(256/32), 1)
        ...
        self.textureViewer.view(self.texture2.textureID, -1, 0.0, 0.5)
        self.textureViewer.view(self.texture1.textureID, -1, 0.5, 0.5)
